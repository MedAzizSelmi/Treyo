...
export default function TrainerMessagesScreen() {
    ...
    const loadData = async () => {
        try {
            ...
            console.log('Trainer messages load error', e);
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <ScreenBackground>
            ...
            >
                ...
                <Text style={styles.pageSubtitle}>Chat with your students</Text>
                ...
                {loading ? (
                    ...
                    <View style={styles.emptyState}>
                        ...
                        <Text style={styles.emptySubtitle}>Start a conversation with your students.</Text>
                    </View>
                )}
            </ScrollView>
        </ScreenBackground>
...
const styles = StyleSheet.create({
    ...
    convAvatar: {
        ...
        borderWidth: 1.5, borderColor: 'rgba(124,206,6,0.2)',
    ...
    onlineDot: {
        ...
        backgroundColor: '#7cce06', borderWidth: 2, borderColor: '#0a0520',
    },
    ...
    unreadBadge: {
        backgroundColor: '#7cce06', borderRadius: 10,
